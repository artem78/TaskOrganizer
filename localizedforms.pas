...
procedure TLocalizedFrame.UpdateTranslation(ALang: String);
begin
...
begin
  ...
  // Update localizable frames
  for i := 0 to ComponentCount - 1 do
  begin
    if Components[i] is TLocalizedFrame then
      (Components[i] as TLocalizedFrame).UpdateTranslation(ALang);
  end;
